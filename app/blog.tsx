...
function FormattedMarkdown(props) {
  return (
    <ReactMarkdown
      components={{
        strong: ({ ...props }) => <strong style={{ color: '#8ccdf2' }} {...props} />,
        em: ({ ...props }) => <em style={{ color: '#b28cf2' }} {...props} />,
        blockquote: ({ ...props }) => <blockquote style={{ color: '#888' }} {...props} />,
      ...
      <div className="body">
        ...
        <div className="post">
          ...
          <div className="content">
            <FormattedMarkdown path={path} remarkPlugins={[remarkFrontmatter]}>
              {content}
            </FormattedMarkdown>
          </div>
        </div>
